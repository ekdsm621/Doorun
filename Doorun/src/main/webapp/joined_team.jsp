             ...
             <div class="col-sm-6" style="margin-top:40px;">
                 <div class="col-sm-12">
                     ...
                     <div class="card" id="make-meeting-card">
                         <div class="card-body row" data-bs-toggle="modal" data-bs-target="#make-meeting">
                     ...
                     <div class="modal fade" id="make-meeting" tabindex="-1">
                         <div class="modal-dialog modal-dialog-centered">
                             <form>
                                 <div class="modal-content" >
                                     <div class="modal-header" style="text-align: center;">
                                         <h5 class="modal-title">모임 주최하기</h5>
                                     </div>
                                     <div class="modal-body" >
										...
										kakao.maps.event.addListener(map, 'click', function(mouseEvent) {        
                                         ...
                                         <input type="date" class="form-control" name="meeting-date">
