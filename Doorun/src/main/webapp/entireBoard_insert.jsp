 	  ...
 	  <div class="container-fluid">
	  	...
	  	<div class="row">
	  		<form method="post" action="insertAction.jsp">
	  			...
	  			<input type="submit" class="btn btn-dark team-making mb-3" value="등록" style="width:80px;">
	  			<a href="entire_board.jsp" class="btn btn-dark team-making mb-3" style="width:80px;">목록</a>
	  		</form>  		
	  	</div>			
	   </div>
